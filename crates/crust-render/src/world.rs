...
pub fn simple_scene() -> (HittableList, LightList) {
    ...
    let ground_material = Arc::new(Lambertian::new(Vec3::new(0.8, 0.5, 0.5)));
    world.add(Box::new(Sphere::new(
        Vec3::new(0.0, -1000.0, 0.0),
        1000.0,
        ground_material,
    ...
    for a in -2..3 {
        for b in -2..3 {
            ...
            let material: Arc<dyn Material> = match (a + b) % 4 {
                0 => Arc::new(Lambertian::new(Vec3::new(0.8, 0.3, 0.3))),
                1 => Arc::new(Metal::new(Vec3::new(0.7, 0.6, 0.5), 0.1)),
                2 => Arc::new(Dielectric::new(1.5)),
                _ => Arc::new(CookTorrance::new(Vec3::new(0.9, 0.9, 0.9), 0.2, 0.5)),
            };
    ...
    let material4 = Arc::new(CookTorrance::new(Vec3::new(0.5, 0.5, 0.5), 0.2, 0.0));
    world.add(Box::new(Sphere::new(
