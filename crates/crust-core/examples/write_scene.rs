...
use crust_core::{Camera, DocObject, Document, MaterialType, ObjectList, Primitive, Vec3A};
...
fn main() {
    ...
    let render_settings =
        crust_core::RenderSettings::new(100, 32, IMAGE_WIDTH, IMAGE_HEIGHT, 32, 0.05, 0);
    ...
    let doc_o1 = DocObject::new(
        ...
        MaterialType::Dielectric(crust_core::Dielectric::new(1.5)),
    );
    ...
    let doc_o2 = DocObject::new(
        ...
        MaterialType::Lambertian(crust_core::Lambertian::new(Vec3A::new(0.4, 0.2, 0.1))),
    );
    ...
    let doc_o3 = DocObject::new(
        ...
        MaterialType::Metal(crust_core::Metal::new(Vec3A::new(0.7, 0.6, 0.5), 0.0)),
    );
    object_list.add(doc_o3);
    let doc_o4 = DocObject::new(
        "center_sphere_4".to_string(),
        Primitive::Sphere {
            center: Vec3A::new(0.0, 1.0, 4.0),
            radius: 1.0,
        },
        MaterialType::CookTorrance(crust_core::CookTorrance::new(
    ...
    let doc_o5 = DocObject::new(
        ...
        MaterialType::Disney(crust_core::Disney::new(
            Vec3A::new(0.5, 0.5, 0.5),
            0.0,
            0.2,
            0.5,
