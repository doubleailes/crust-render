...
use crust_render::{Camera, DocObject, Document, MaterialType, ObjectList, Primitive, Vec3A};
...
fn main() {
    ...
    for a in -2..3 {
        for b in -2..3 {
            ...
            let material: MaterialType = match (a + b) % 4 {
                0 => MaterialType::Lambertian(crust_render::Lambertian::new(Vec3A::new(
                    0.8, 0.3, 0.3,
                ))),
                1 => MaterialType::Metal(crust_render::Metal::new(Vec3A::new(0.7, 0.6, 0.5), 0.1)),
    ...
    let doc_o2 = DocObject::new(
        ...
        MaterialType::Lambertian(crust_render::Lambertian::new(Vec3A::new(0.4, 0.2, 0.1))),
    );
    ...
    let doc_o3 = DocObject::new(
        ...
        MaterialType::Metal(crust_render::Metal::new(Vec3A::new(0.7, 0.6, 0.5), 0.0)),
    );
